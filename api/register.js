...
export default async function handler(req, res) {
  ...
  const { error: emailError } = await resend.emails.send({
    from: 'الفعالية السنوية <noreply@yourdomain.com>', // ← غيّر هذا لدومينك
    to: email,
    ...
    html: `
      ...
      <body style="margin:0;padding:0;background:#f4f2ee;font-family:'Tajawal',Arial,sans-serif;direction:rtl;">
                ...
                <tr>
                  <td style="padding:32px;">
                    ...
                    <p style="font-size:14px;color:#6b7280;line-height:1.7;margin:0 0 28px;">
                      شكراً لتسجيلك في الفعالية السنوية. فيما يلي رمز تسجيلك الخاص:
                    </p>
                    ...
                    <p style="font-size:14px;color:#6b7280;line-height:1.7;margin:0 0 8px;">
                      ⚠️ يرجى الاحتفاظ بهذا الرمز وإبرازه عند الحضور.
                    </p>

                    <!-- Details -->
                    <table width="100%" style="background:#f9fafb;border-radius:8px;padding:16px;margin-top:20px;" cellpadding="0" cellspacing="0">
                      <tr><td style="font-size:13px;color:#9ca3af;padding:4px 0;">الاسم الكامل</td><td style="font-size:13px;color:#1a1a1a;text-align:left;">${firstName} ${lastName}</td></tr>
                      <tr><td style="font-size:13px;color:#9ca3af;padding:4px 0;">البريد الإلكتروني</td><td style="font-size:13px;color:#1a1a1a;text-align:left;">${email}</td></tr>
                      <tr><td style="font-size:13px;color:#9ca3af;padding:4px 0;">رقم الهاتف</td><td style="font-size:13px;color:#1a1a1a;text-align:left;">${phone}</td></tr>
                    </table>
                  </td>
                </tr>
                <!-- Footer -->
  ...
  if (emailError) {
    ...
    // Still return code even if email fails — log the issue
